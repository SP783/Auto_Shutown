...
class ScheduleChecker:
    """Check if monitoring should be active based on schedule settings (no date range UI)"""
...
class WindowMonitorApp(QMainWindow):
    ...
    def apply_saved_settings(self):
        ...
        self.quality_slider.setValue(scc.get("quality", 60))
        self.quality_label.setText(f"{scc.get('quality', 60)}%")
        self.max_files_spin.setValue(scc.get("max_files", 500))
        self.cleanup_days_spin.setValue(scc.get("auto_cleanup_days", 15))
        ...
        self.shutdown_timer_spin.setValue(st.get("shutdown_timer_minutes", 30))
        self.auto_resume_spin.setValue(st.get("auto_resume_minutes", 30))
        self.poll_interval_spin.setValue(int(st.get("poll_interval", 5)))
